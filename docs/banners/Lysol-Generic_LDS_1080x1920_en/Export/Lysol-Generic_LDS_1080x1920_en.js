...
(lib.LysolGeneric_LDS_1080x1920_en = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(235).to({_off:false},0).to({y:400},18,cjs.Ease.get(1)).wait(197));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(94).to({_off:false},0).to({alpha:1},13).wait(94).to({alpha:0},31).to({_off:true},13).wait(205));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(78).to({_off:false},0).to({y:1058.85,alpha:1},15,cjs.Ease.get(1)).wait(1).to({mode:"synched",loop:false},0).to({x:608.65,startPosition:51},51).wait(56).to({startPosition:107},0).to({alpha:0,startPosition:138},31).to({_off:true},13).wait(205));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(71).to({_off:false},0).to({y:938.2,alpha:1},15,cjs.Ease.get(1)).wait(115).to({alpha:0},31).to({_off:true},13).wait(205));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(24).to({_off:false},0).to({alpha:1},15).wait(24).to({y:844.65},15,cjs.Ease.get(1)).wait(123).to({alpha:0},31).to({_off:true},13).wait(205));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(94).to({_off:false},0).wait(107).to({startPosition:107},0).to({alpha:0,startPosition:138},31).to({_off:true},13).wait(205));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Group_1_0.png?1574364087631", id:"Group_1_0"},
		{src:"images/boy.jpg?1574364087631", id:"boy"},
		{src:"images/germs.png?1574364087631", id:"germs"},
		{src:"images/hand_spray.png?1574364087631", id:"hand_spray"},
		{src:"images/product.png?1574364087631", id:"product"},
		{src:"images/spray_01.png?1574364087631", id:"spray_01"},
		{src:"images/spray_02.png?1574364087631", id:"spray_02"},
		{src:"images/whatittaketoprotect.png?1574364087631", id:"whatittaketoprotect"}
	],
	preloads: []
};
