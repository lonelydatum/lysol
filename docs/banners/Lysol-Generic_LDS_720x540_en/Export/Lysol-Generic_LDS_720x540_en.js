...
(lib.copy_03 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(176.025,44.175);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#2B3785").s().p("");
	this.shape_1.setTransform(167.7,40.7);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#2B3785").s().p("");
	this.shape_2.setTransform(153.05,40.575);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#2B3785").s().p("AglA3IAAhqIAhAAIAAARIABAAQAEgKAHgFQAIgFALAAIAFAAIAGABIAAAeIgHgBIgHgBQgKAAgFADQgGADgDAEQgCAFgBAHIgBANIAAAtg");
	this.shape_3.setTransform(139.475,40.575);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#2B3785").s().p("AgSA0QgLgEgIgHQgIgHgEgLQgFgKAAgNQAAgMAFgKQAEgLAIgHQAIgHALgEQALgEAMAAQALAAAJAEQAKAEAGAHQAHAHADALQAEAKAAAMIAAALIhMAAQACAJAHAGQAGAFAJAAQAIAAAGgDQAFgEAFgGIAXARQgIAKgMAFQgMAGgNAAQgMAAgLgEgAAWgLQAAgJgGgFQgGgHgJAAQgEAAgEACQgEACgDADQgDADgCAEQgCADAAAEIArAAIAAAAg");
	this.shape_4.setTransform(128.275,40.7);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#2B3785").s().p("");
	this.shape_5.setTransform(114.675,43.225);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#2B3785").s().p("AgfAzQgIgEgEgHQgFgGgBgKQgBgJAAgLIAAg6IAgAAIAAA1IABAIIACAJQABAFAEACQADADAHAAQAFAAAEgCQAEgDACgEQADgDAAgFIAAgJIAAg2IAhAAIAABqIgfAAIAAgOIAAAAIgFAGIgHAFIgIAEQgFACgGAAQgMAAgIgEg");
	this.shape_6.setTransform(95.3,40.825);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#2B3785").s().p("AgPBTIAAilIAgAAIAAClg");
	this.shape_7.setTransform(86.15,37.725);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#2B3785").s().p("AgTBVIAAhRIgVAAIAAgZIAVAAIAAgTQAAgJACgIQABgIAFgGQAEgFAHgEQAJgDANAAIAKAAIAJABIgBAcIgFgBIgGgBQgIAAgEADQgEAEAAALIAAARIAZAAIAAAZIgZAAIAABRg");
	this.shape_8.setTransform(79.475,37.6);
	...
	this.shape_9.setTransform(60.775,38.275);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#2B3785").s().p("AgaBQQgKgDgHgIQgHgHgDgKQgEgLAAgMQAAgLADgKQAEgJAGgIQAGgIAJgFQAJgEAMgBQAJAAAJADQAJAEAGAIIAAAAIAAhHIAhAAIAAClIgeAAIAAgOIgBAAIgFAFIgHAGIgKAEIgJABQgMAAgKgEgAgRAJQgHAHAAAMQAAAMAHAIQAHAHALAAQANAAAHgHQAHgIAAgMQAAgMgHgHQgHgIgNAAQgLAAgHAIg");
	this.shape_10.setTransform(38.275,37.85);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#2B3785").s().p("AgQBTIAAilIAhAAIAAClg");
	this.shape_11.setTransform(28.85,37.725);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#2B3785").s().p("AgWA0QgLgEgIgHQgIgHgEgLQgFgKgBgNQABgMAFgKQAEgLAIgHQAIgHALgEQALgEALAAQAMAAAMAEQAKAEAIAHQAIAHAFALQAFAKAAAMQAAANgFAKQgFALgIAHQgIAHgKAEQgMAEgMAAQgLAAgLgEgAgSgSQgIAHAAALQAAAMAIAIQAHAHALAAQANAAAGgHQAIgIAAgMQAAgLgIgHQgGgIgNAAQgLAAgHAIg");
	this.shape_12.setTransform(19.3,40.7);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#2B3785").s().p("AgMA0QgLgEgIgHQgIgHgEgLQgFgKAAgNQAAgMAFgKQAEgLAIgHQAIgHALgEQALgEAMAAQAJAAAKADQALAEAIAHIgWAXQgDgDgEgDQgEgCgFAAQgMAAgHAIQgHAHAAALQAAAMAHAIQAHAHAMAAQAFAAAEgDIAHgFIAWAXQgIAHgLAEQgKADgJAAQgMAAgLgEg");
	this.shape_13.setTransform(7.725,40.7);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#2B3785").s().p("AgTBVIAAhRIgVAAIAAgZIAVAAIAAgTQAAgJACgIQABgIAFgGQAEgFAHgEQAJgDANAAIAKAAIAJABIgBAcIgFgBIgGgBQgIAAgEADQgEAEAAALIAAARIAZAAIAAAZIgZAAIAABRg");
	this.shape_14.setTransform(137.925,15.55);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#2B3785").s().p("AgWA0QgLgEgIgHQgIgHgFgLQgEgKgBgNQABgMAEgKQAFgLAIgHQAIgHALgEQALgEALAAQAMAAAMAEQAKAEAIAHQAIAHAFALQAFAKAAAMQAAANgFAKQgFALgIAHQgIAHgKAEQgMAEgMAAQgLAAgLgEgAgSgSQgIAHAAALQAAAMAIAIQAGAHAMAAQAMAAAHgHQAIgIgBgMQABgLgIgHQgHgIgMAAQgMAAgGAIg");
	this.shape_15.setTransform(126.95,18.65);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#2B3785").s().p("AAAAMIgLAQIgLgIIALgQIgTgGIAFgNIATAHIAAgUIANAAIAAAUIATgGIAFANIgTAFIALARIgLAIg");
	this.shape_16.setTransform(110.35,9.1);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#2B3785").s().p("");
	this.shape_17.setTransform(96.925,16.2);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#2B3785").s().p("AgiBPIAjg3IgDABIgGAAQgLAAgJgEQgJgEgHgHQgGgGgDgJQgEgJAAgLQAAgMAFgKQAEgJAIgHQAHgHALgEQALgEALAAQAMAAALAEQALAEAIAHQAHAHAFAJQAEAKAAAMQAAAJgCAHIgDAMIgHALIgHAMIghA1gAgRgpQgHAHAAALQAAAKAHAHQAHAGAKAAQAMAAAGgGQAHgHAAgKQAAgLgHgHQgGgHgMAAQgKAAgHAHg");
	this.shape_18.setTransform(80.5,16.075);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#2B3785").s().p("AgHATQgEgCgDgDIgEgGQgBgEAAgEIABgHIAEgHIAHgEIAHgBIAIABQAEACACACIAEAHQACAEAAADQAAAEgCAEIgEAGQgCADgEACIgIABIgHgBg");
	this.shape_19.setTransform(70.725,22.125);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#2B3785").s().p("AgiBPIAjg3IgDABIgGAAQgLAAgJgEQgJgEgHgHQgGgGgEgJQgDgJAAgLQAAgMAEgKQAFgJAIgHQAHgHALgEQALgEALAAQAMAAALAEQAKAEAJAHQAHAHAEAJQAFAKAAAMQAAAJgBAHIgFAMIgGALIgGAMIgiA1gAgRgpQgHAHAAALQAAAKAHAHQAHAGAKAAQALAAAHgGQAHgHAAgKQAAgLgHgHQgHgHgLAAQgKAAgHAHg");
	this.shape_20.setTransform(61,16.075);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#2B3785").s().p("AgiBPIAjg3IgEABIgFAAQgLAAgJgEQgJgEgGgHQgHgGgDgJQgEgJAAgLQAAgMAFgKQAEgJAIgHQAHgHALgEQALgEALAAQAMAAALAEQALAEAHAHQAIAHAFAJQAEAKAAAMQAAAJgCAHIgDAMIgHALIgHAMIgiA1gAgRgpQgHAHAAALQAAAKAHAHQAHAGAKAAQAMAAAGgGQAHgHAAgKQAAgLgHgHQgGgHgMAAQgKAAgHAHg");
	this.shape_21.setTransform(48,16.075);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#2B3785").s().p("AgQBTIAAilIAgAAIAAClg");
	this.shape_22.setTransform(32.1,15.675);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#2B3785").s().p("AgPBTIAAilIAgAAIAAClg");
	this.shape_23.setTransform(26.4,15.675);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#2B3785").s().p("AgPBQIAAhqIAfAAIAABqgAgMguQgGgGAAgIQAAgIAGgFQAFgGAHAAQAIAAAFAGQAGAFAAAIQAAAIgGAGQgFAFgIAAQgHAAgFgFg");
	this.shape_24.setTransform(20.7,16.025);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#2B3785").s().p("AAZBOIg/hKIAABKIgiAAIAAibIAiAAIAABBIA8hBIAtAAIhFBJIBLBSg");
	this.shape_25.setTransform(11,16.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_25},{t:this.shape_24},{t:this.shape_23},{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.copy_03, new cjs.Rectangle(0,0,181.5,56.1), null);
...
// stage content:
(lib.LysolGeneric_LDS_720x540_en = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.instance_4.setTransform(265.85,268.3,2.3025,2.3025,0,0,0,82,27.3);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(322).to({_off:false},0).to({x:219.8,alpha:1},13,cjs.Ease.get(1)).wait(115));

	// copy_02
	this.instance_5 = new lib.copy_02();
	this.instance_5.setTransform(360.95,266.95,2.3025,2.3025,0,0,0,122.8,27.7);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(269).to({_off:false},0).to({alpha:1},15,cjs.Ease.get(1)).to({_off:true},38).wait(128));

	// logo
	this.instance_6 = new lib.logo();
	this.instance_6.setTransform(656.1,478.1,1.8812,1.8812,0,0,0,24.5,23);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(163).to({_off:false},0).to({alpha:1},15,cjs.Ease.get(1)).to({_off:true},144).wait(128));

	// bg_light_blue
	this.instance_7 = new lib.bg_lightblue();
	this.instance_7.setTransform(235.2,-270,2.3999,2.16,0,0,0,98,125);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(258).to({_off:false},0).to({y:270},11,cjs.Ease.get(1)).wait(181));

	// hand
	this.instance_8 = new lib.hand_spray_1("single",0);
	this.instance_8.setTransform(-48.1,435.05,1,1,-22.7187,0,0,-0.1,112);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(178).to({_off:false},0).to({regX:0,rotation:0,x:105,y:335},4,cjs.Ease.get(1)).wait(3).to({mode:"synched"},0).to({regX:0.1,rotation:4.9513,x:100.95,startPosition:12},20,cjs.Ease.get(1)).to({regX:-0.1,rotation:-7.0392,x:99.8,y:345,startPosition:38},20,cjs.Ease.get(1)).to({regX:0,rotation:0,x:105,y:335,mode:"single",startPosition:0},33,cjs.Ease.get(1)).to({y:725},9,cjs.Ease.get(1)).wait(183));

	// spray
	this.instance_9 = new lib.spray_mist("synched",0);
	this.instance_9.setTransform(225,275,0.6263,0.6263,0,0,0,150,150.2);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(185).to({_off:false},0).to({regX:149.8,regY:149.8,scaleX:1.486,scaleY:1.486,x:224.9,y:274.65,alpha:0.2813},40,cjs.Ease.get(1)).to({scaleX:2.1808,scaleY:2.1808,x:225,y:274.75,alpha:0},10).to({_off:true},4).wait(211));

	// copy_01c
	this.instance_10 = new lib.copy_01c();
	this.instance_10.setTransform(111.65,511.15,2.3025,2.3025,0,0,0,104.5,8.8);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(94).to({_off:false},0).to({alpha:1},13).wait(91).to({alpha:0},56).to({_off:true},1).wait(195));

	// copy_01b
	this.instance_11 = new lib.copy_01b("single",0);
	this.instance_11.setTransform(298.85,360.45,2.0722,2.0722,0,0,0,136.1,25.9);
	this.instance_11.alpha = 0;
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(78).to({_off:false},0).to({y:339.75,alpha:1},15,cjs.Ease.get(1)).wait(1).to({mode:"synched",loop:false},0).to({x:400.4,startPosition:51},51,cjs.Ease.get(0.2)).wait(53).to({startPosition:112},0).to({alpha:0,startPosition:137},56).to({_off:true},1).wait(195));

	// copy_01a
	this.instance_12 = new lib.copy_01a();
	this.instance_12.setTransform(360.9,291.05,2.0722,2.0722,0,0,0,91,22.5);
	this.instance_12.alpha = 0;
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(71).to({_off:false},0).to({y:270.3,alpha:1},15,cjs.Ease.get(1)).wait(112).to({alpha:0},56).to({_off:true},1).wait(195));

	// copy_01
	this.instance_13 = new lib.copy_01();
	this.instance_13.setTransform(386.35,284.8,2.0722,2.0722,0,0,0,84.3,25.9);
	this.instance_13.alpha = 0;
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(24).to({_off:false},0).to({alpha:1},15).wait(24).to({y:216.4},15,cjs.Ease.get(1)).wait(120).to({alpha:0},56).to({_off:true},1).wait(195));

	// germs
	this.instance_14 = new lib.germs_1("synched",0,false);
	this.instance_14.setTransform(-150.75,-16.05,0.533,0.533,0,0,0,0.1,0);
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(94).to({_off:false},0).wait(104).to({startPosition:112},0).to({alpha:0,startPosition:137},56).to({_off:true},1).wait(195));

	// white_box
	this.instance_15 = new lib.whitebox();
	this.instance_15.setTransform(360,270,2.3999,2.1601,0,0,0,150,125);
	...
	this.instance_16.setTransform(656.1,478.1,1.8812,1.8812,0,0,0,24.5,23);
	...
	this.instance_17.setTransform(-61.65,61.1,0.5333,0.5333,0,0,0,169.4,144.7);
	...
	this.instance_18.setTransform(360,270,2.4,2.1601,0,0,0,150,125);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Group_1_0.png?1573838797751", id:"Group_1_0"},
		{src:"images/boy.png?1573838797751", id:"boy"},
		{src:"images/germs.png?1573838797751", id:"germs"},
		{src:"images/hand_spray.png?1573838797751", id:"hand_spray"},
		{src:"images/productpngcopy.png?1573838797751", id:"productpngcopy"},
		{src:"images/spray_01.png?1573838797751", id:"spray_01"},
		{src:"images/spray_02.png?1573838797751", id:"spray_02"},
		{src:"images/whatittaketoprotectpngcopy.png?1573838797751", id:"whatittaketoprotectpngcopy"}
	],
	preloads: []
};
